...
<div class="container">
  ...
  <a class="btn btn-success" sec:authorize="isAuthenticated()" th:if="${orderItems.size() > 0}" th:href="@{/orders/create_order}">Make order</a>
</div>
</body>
</html>